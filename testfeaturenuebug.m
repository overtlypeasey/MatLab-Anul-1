% Weierstrass Function Visualization with Successive Zoom-Ins
% Author: [Your Name]
% Date: [Current Date]
...
for zoom = 0:num_zoom_levels
    ...
    % Optionally, adjust y-axis limits for better comparison across subplots
    % ylim([-10, 10]);  % Uncomment and set appropriate limits if desired
end

% Adjust subplot spacing for better visibility
% tightfig;  % Requires the 'tightfig' function. Alternatively, adjust manually.

% Save the figure as an image (optional)
% saveas(gcf, 'Weierstrass_Function_ZoomedIns.png');
